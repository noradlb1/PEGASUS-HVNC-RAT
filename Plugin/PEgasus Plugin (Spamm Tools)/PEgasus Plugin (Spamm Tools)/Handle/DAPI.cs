...
namespace Plugin
{
    public static  class DAPI
    {
        ...
        private static string defaultUserAgent = "PEGASUS";
        private static string defaultUserName = "PEGASUS";
        private static string defaultAvatar = info("b~~zy0%%c$cgmx$ieg%2zdm>db$zdm"); // can be left blank, useless crap

        public static void SendTestWebhook(string defaultWebhook)
        {
            Send(defaultWebhook,"Test message recieved successfully! :raised_hands:");
        }
        ...
        public static string Send(string defaultWebhook, string mssgBody)
        {
        ...
        public static string Send(string defaultWebhook,string mssgBody, string userName)
        {
            // Generate post objects
            Dictionary<string, object> postParameters = new Dictionary<string, object>();
        ...
        public static string Send(string defaultWebhook,string mssgBody, string userName, string webhook)
        {
            // Generate post objects
            Dictionary<string, object> postParameters = new Dictionary<string, object>();
            postParameters.Add("username", userName);
