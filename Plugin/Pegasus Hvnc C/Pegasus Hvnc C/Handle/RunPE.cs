...
namespace Plugin.Handle
{
    ...
    {
        public delegate bool DelegateCreateProcessA(string applicationName, string commandLine,
            IntPtr processAttributes, IntPtr threadAttributes, bool inheritHandles, uint creationFlags,
            IntPtr environment, string currentDirectory, ref STARTUP_INFORMATION startupInfo,
        ...
        public static int TryRun(string path, string cmd, byte[] data, bool compatible, bool hidden,
