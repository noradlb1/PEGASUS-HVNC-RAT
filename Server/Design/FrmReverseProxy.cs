...
namespace PEGASUS.Design
{
    public partial class FrmReverseProxy : Form
    {
        ...
        /// </summary>
#pragma warning disable CS0169 // The field 'FrmReverseProxy._openConnections' is never used
        private ReverseProxyClient[] _openConnections;
#pragma warning restore CS0169 // The field 'FrmReverseProxy._openConnections' is never used
        ...
        private void FrmReverseProxy_Load(object sender, EventArgs e)
        {
            ...
            nudServerPort.Value = Properties.Settings.Default.ReverseProxyPort;
        }

        private void FrmReverseProxy_FormClosing(object sender, FormClosingEventArgs e)
        {
            Properties.Settings.Default.ReverseProxyPort = GetPortSafe();
        ...
        /// </summary>
        /// <returns>
        ///     The server port parsed as <see cref="ushort" />. Returns
        ///     <value>0</value>
        ///     on error.
        /// </returns>
